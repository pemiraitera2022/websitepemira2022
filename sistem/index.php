...
if(isset($_POST['simpan'])) {
  ...
  $cek = mysqli_num_rows(mysqli_query($koneksi,"SELECT * FROM tbl_calon WHERE kode_akses='$kode_akses'"));
  if ($cek > 0){
    echo"<script>window.alert('Anda tidak bisa melakukan voting lagi')
          ...
          mysqli_query($koneksi,"INSERT INTO tbl_calon(kode_akses, nomor_calon)
        ...
        <div class="adjust-nav">
          <div class="navbar-header">
            ...
            <a class="navbar-brand" href="#">
              ...
              <h4 style="color: white;">Sistem E-Vote Pemira PMK</h4>
            </a> 
          </div>
          ...
          <div class="row">
            <div class="col-lg-12 ">
              <div class="alert alert-info">
                <strong><h2><b>Shalom <?php echo $_SESSION['nama_mhs']; ?></b></h2></strong><b style="font-size: 20px;"></b>
              </div>   
            </div>
          </div>
          ...
          <div class="row">
            <div class="col-lg-12">
             <div class="alert alert-success">
              <div class="row">
                <div class="col-lg-12">
                  <h2 align="center"><b>CALON KETUA PMK ITERA</b></h2><br>
                  <form action="" method="post">
                    <?php
                    $data_calon = mysqli_query($koneksi,"SELECT * FROM data_calon");
                    while($d = mysqli_fetch_array($data_calon)){
                      ?>
                      <div class="col-lg-6">
                        <table class="table table-striped table-bordered table-hover">
                          <tr>
                            <td colspan="2" style="background-color: gray; color: white; font-size: 30px; text-align: center;"><b><?php echo $d['no_urut']; ?></b>
                            </td>
                          </tr>
                          <tr>
                            <td><img style="width: 100%; height:100%" src="<?php echo "foto/".$d['gambar1']; ?>"></td>
                          </tr>
                          <tr>
                          ...
                          <tr>
                            <td colspan="2" align = "center">
                              <h4><?php echo $d['nm_calon_ketua']; ?></h4>
                              <h4><?php echo $d['prodi']; ?></h4>
                            </td>
                          </tr>
                          <tr>
