...
if(isset($_POST['simpan'])) {
  ...
  if($_POST['simpan']){
    ...
    if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
      if($ukuran <= 2000000){          
        ...
        $query = mysqli_query ($koneksi, "INSERT INTO data_calon (gambar1) VALUES( '$gambar1')");
        ...
        if(in_array($ekstensi, $ekstensi_diperbolehkan) === true){
          if($ukuran <= 2000000){          
            ...
            $query = mysqli_query($koneksi, "INSERT INTO data_calon (gambar2) VALUES('$gambar2')");
          }
        }
      }
    }
  ...
  mysqli_query($koneksi,"INSERT INTO data_calon(id, nim_ketua, nm_calon_ketua, gambar1, prodi, gambar2, no_urut)
    VALUES ('','$nim_ketua','$nm_calon_ketua','$gambar1','$prodi','$gambar2','$no_urut')");
        ...
        <div class="col-lg-6">
          <form action="" method="post" enctype="multipart/form-data">
            <div class="form-group">
              <label>NIM Calon Ketua PMK</label>
              <input type="text" name="nim_ketua" required="required" class="form-control">
            </div>
            <div class="form-group">
              <label>Nama Calon Ketua PMK</label>
              <input type="text" name="nm_calon_ketua" required="required" autocomplete="off" class="form-control">
            </div>
            <div class="form-group">
              <label>Prodi Calon Ketua PMK</label>
              <input type="text" name="prodi" required="required" autocomplete="off" class="form-control">
            </div>
            <div class="form-group">
